...
HD_PWD='C:/Users/VLSI/Desktop/Vivado_Code/Accelerator_Templete/Accelerator_Templete.runs/sram_1440kb_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sram_1440kb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sram_1440kb.tcl
