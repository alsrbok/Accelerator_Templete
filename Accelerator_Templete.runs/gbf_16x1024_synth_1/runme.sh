...
HD_PWD='C:/Users/VLSI/Desktop/Vivado_Code/Accelerator_Templete/Accelerator_Templete.runs/gbf_16x1024_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gbf_16x1024.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gbf_16x1024.tcl
