...
HD_PWD='C:/Users/VLSI/Desktop/Vivado_Code/Accelerator_Templete/Accelerator_Templete.runs/psum_gbf_512x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log psum_gbf_512x32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source psum_gbf_512x32.tcl
