...
REM
REM Generated by Vivado on Fri Aug 26 15:38:26 +0900 2022
...
echo "xvlog --incr --relax -prj psum_gbf_su_tb_vlog.prj"
call xvlog  --incr --relax -prj psum_gbf_su_tb_vlog.prj -log xvlog.log
