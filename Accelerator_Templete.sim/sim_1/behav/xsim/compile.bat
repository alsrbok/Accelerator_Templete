...
REM
REM Generated by Vivado on Thu Aug 18 12:29:41 +0900 2022
...
echo "xvlog --incr --relax -prj PE_new_tb_vlog.prj"
call xvlog  --incr --relax -prj PE_new_tb_vlog.prj -log xvlog.log
