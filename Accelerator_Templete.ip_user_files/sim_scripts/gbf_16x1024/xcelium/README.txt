...
#
# Generated by export_simulation on Fri Aug 19 15:25:54 +0900 2022
#
################################################################################
...
'-reset_run' switch to the './gbf_16x1024.sh' script.

./gbf_16x1024.sh -reset_run
...
./gbf_16x1024.sh -noclean_files

For more information on the script, please type './gbf_16x1024.sh -help'.
